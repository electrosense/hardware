...
void hal_lld_init(void) {
  ...
  PIT_HSM.MCR.R         = 1;
  PIT_HSM.CH[0].LDVAL.R = n;
  PIT_HSM.CH[0].CVAL.R  = n;
  PIT_HSM.CH[0].TFLG.R  = 1;            /* Interrupt flag cleared.          */
  PIT_HSM.CH[0].TCTRL.R = 3;            /* Timer active, interrupt enabled. */
