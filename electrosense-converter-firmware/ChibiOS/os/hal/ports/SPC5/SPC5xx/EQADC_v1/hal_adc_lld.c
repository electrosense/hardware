...
/**
 * @file    SPC5xx/EQADC_v1/hal_adc_lld.c
...
void adc_lld_start(ADCDriver *adcp) {
  ...
  osalDbgAssert(adc_active_fifos < 6, "too many FIFOs");
  ...
  osalDbgAssert((adcp->cfifo_channel != EDMA_ERROR) &&
...
void adc_lld_start_conversion(ADCDriver *adcp) {
  ...
  osalDbgAssert(adcp->grpp->num_iterations >= adcp->depth,
                "too many elements");
