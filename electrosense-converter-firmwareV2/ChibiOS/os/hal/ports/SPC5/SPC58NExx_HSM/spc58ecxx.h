...
#ifndef _SPC58NE_EG_H_
#define _SPC58NE_EG_H_
...
* ----- ----------- ------------ -------------------------------------------------------*
* 2.0D1 04-Dec-2015    Rev. 2	 Renamed file from SPC58NEx.h (Rev. 1) to SPC58NE_EG.h  *
*                                (SPC58NEx/SPC58EGx).                                   *
*                                Renamed all CMU instances by removing IP names after   *
*                                instance numbers.                                      *
*                                Updated with new modules ETHERNET and PCM.             *
*                                Removed instances INTC_0 and XBIC_2.                   *
*                                Renamed module LINFLEX with LINFLEXD and added 2       *
*                                instances, LINFLEXD_16 and LINFLEX_17.                 *
*                                Substantial changes.                                   *
* ----- ----------- ------------ -------------------------------------------------------*
*  1.2  15-Jun-2015     Rev. 1   SPC58NEx.h is compliant with the SPC58NE84/SPC58EG84   *
...
struct MC_ME_tag {
    ...
    union {
        ...
        struct {
            ...
            vuint32_t S_ADCSAR_12BIT_2:1;
            vuint32_t unused_6:6;
            vuint32_t S_ADCSAR_10BIT_0:1;
    ...
    union {
        ...
        struct {
            ...
            vuint32_t S_ADCSAR_12BIT_SEQ_2:1;
            vuint32_t S_ADCSAR_12BIT_SEQ_1:1;
            vuint32_t S_ADCSAR_12BIT_SEQ_3:1;
            vuint32_t unused_1:4;
            vuint32_t S_ADCSAR_10BIT_SEQ_0:1;
            vuint32_t S_ADCSAR_10BIT_SEQ_1:1;
            vuint32_t unused_0:3;
    ...
    union {
        ...
        struct {
            ...
            vuint32_t unused_2:3;
            vuint32_t S_FLEXRAY_1_CONTROL:1;
            vuint32_t unused_1:2;
...
struct PCM_tag {
    ...
    union {
        ...
        struct {
            ...
            vuint32_t unused_3:1;
            vuint32_t PRE_AIPS2_GSKT:1;
            vuint32_t BRE_AIPS2_GSKT:1;
            vuint32_t BWE_AIPS2_GSKT:1;
            vuint32_t unused_2:1;
            vuint32_t PRE_AIPS1_GSKT:1;
            vuint32_t BRE_AIPS1_GSKT:1;
            vuint32_t BWE_AIPS1_GSKT:1;
            vuint32_t unused_1:1;
    ...
    union {
        ...
        struct {
            ...
            vuint32_t PRE_AIPS0_GSKT:1;
            vuint32_t BRE_AIPS0_GSKT:1;
            vuint32_t BWE_AIPS0_GSKT:1;
            vuint32_t unused_2:1;
...
struct PMCDIG_tag {
    ...
    union {
        ...
        struct {
            vuint32_t unused_0:1;
            vuint32_t BIST_MAKS:15;
            vuint32_t BIST_MASK:16;
        } B;
    } BIST_MASK_STATUS;
...
#define ETHERNET_1              (*(volatile struct ETHERNET_tag *) 0xfbc54000)
...
#define LINFLEXD_5              (*(volatile struct LINFLEXD_tag *) 0xfbe94000)
#define LINFLEXD_6              (*(volatile struct LINFLEXD_tag *) 0xf7e98000)
#define LINFLEXD_7              (*(volatile struct LINFLEXD_tag *) 0xfbe98000)
#define LINFLEXD_8              (*(volatile struct LINFLEXD_tag *) 0xf7e9c000)
#define LINFLEXD_9              (*(volatile struct LINFLEXD_tag *) 0xfbe9c000)
#define LINFLEXD_10             (*(volatile struct LINFLEXD_tag *) 0xf7ea0000)
#define LINFLEXD_11             (*(volatile struct LINFLEXD_tag *) 0xfbea0000)
#define LINFLEXD_12             (*(volatile struct LINFLEXD_tag *) 0xf7ea4000)
#define LINFLEXD_13             (*(volatile struct LINFLEXD_tag *) 0xfbea4000)
#define LINFLEXD_14             (*(volatile struct LINFLEXD_tag *) 0xf7ea8000)
#define LINFLEXD_15             (*(volatile struct LINFLEXD_tag *) 0xfbea8000)
#define LINFLEXD_16             (*(volatile struct LINFLEXD_tag *) 0xf7eac000)
#define LINFLEXD_17             (*(volatile struct LINFLEXD_tag *) 0xfbeac000)
