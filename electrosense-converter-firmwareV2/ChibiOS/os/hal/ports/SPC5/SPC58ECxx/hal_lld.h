...
/**
 * @file    SPC58ECxx/hal_lld.h
 * @brief   SPC58ECxx HAL subsystem low level driver header.
 ...
 * @{
 */
#define PLATFORM_NAME                       "SPC58ECxx Automotive Body Electronics Applications"
/** @} */
 ...
 */
#define SPC5_PLL1IN_MIN                     37500000

/**
 * @brief   Maximum PLL1 input clock frequency.
 */
#define SPC5_PLL1IN_MAX                     87500000

/**
 * @brief   Maximum PLL0 VCO clock frequency.
 */
#define SPC5_PLL0VCO_MAX                    1400000000
 ...
 */
#define SPC5_PLL1VCO_MAX                    1400000000
 ...
 */
#define SPC5_PLL1_CLK_MAX                   200000000
 ...
 */
#define SPC5_AC0_DC0_CLK_MAX                16000000

/**
 * @brief   Maximum AC0 DC1 clock frequency.
 */
#define SPC5_AC0_DC1_CLK_MAX                100000000

/**
 * @brief   Maximum AC6 DC0 clock frequency.
 */
#define SPC5_AC6_DC0_CLK_MAX                20000000
 ...
 */
#define SPC5_AC12_DC3_CLK_MAX               80000000
 ...
 * @{
 */
#define SPC5_PLL0_CR_CLKCFG_MASK            (3U << 8)
#define SPC5_PLL0_CR_CLKCFG_OFF             (0U << 8)
#define SPC5_PLL0_CR_CLKCFG_RUNNING         (3U << 8)
#define SPC5_PLL0_CR_EXPDIE                 (1U << 7)
#define SPC5_PLL0_CR_LOLIE                  (1U << 3)

#define SPC5_PLL0_SR_EXTPDF                 (1U << 7)
#define SPC5_PLL0_SR_LOLF                   (1U << 3)
 ...
 * @{
 */
#define SPC5_PLL1_CR_CLKCFG_MASK            (3U << 8)
#define SPC5_PLL1_CR_CLKCFG_OFF             (0U << 8)
#define SPC5_PLL1_CR_CLKCFG_RUNNING         (3U << 8)
#define SPC5_PLL1_CR_EXPDIE                 (1U << 7)
#define SPC5_PLL1_CR_LOLIE                  (1U << 3)

#define SPC5_PLL1_SR_EXTPDF                 (1U << 7)
#define SPC5_PLL1_SR_LOLF                   (1U << 3)
...
#define SPC5_CGM_SC_DC4_DIV_VALUE           4
#endif
...
#define SPC5_CGM_AC0_DC0_DIV_VALUE          25
#endif
...
#define SPC5_CGM_AC0_DC1_DIV_VALUE          4
#endif
...
#if !defined(SPC58ECxx_MCUCONF)
#error "Using a wrong mcuconf.h file, SPC58ECxx_MCUCONF not defined"
#endif
...
#elif (SPC5_CGM_AC0_DC0_DIV_VALUE >= 1) && (SPC5_CGM_AC0_DC0_DIV_VALUE <= 128)
...
#elif (SPC5_CGM_AC0_DC1_DIV_VALUE >= 1) && (SPC5_CGM_AC0_DC1_DIV_VALUE <= 16)
